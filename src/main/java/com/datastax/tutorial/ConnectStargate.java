...
public class ConnectStargate {
    ...
    private static final int    STARGATE_GRPC_PORT     = 9191;
                ...
                QueryOuterClass.Batch.newBuilder()
                    .addQueries(
                        QueryOuterClass.BatchQuery.newBuilder()
                            .setCql("INSERT INTO test.users (firstname, lastname) VALUES('Lorina', 'Poland')")
                            .build())
                    .addQueries(
                        QueryOuterClass.BatchQuery.newBuilder()
                            .setCql("INSERT INTO test.users (firstname, lastname) VALUES('Doug', 'Wettlaufer')")
                            .build())
                    .build());
